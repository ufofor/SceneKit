...
//  Hello AR World
//
//  Created by Sean Kang on 2020/11/07.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func drawSphereAtOrigin() {
        let spere = SCNNode(geometry: SCNSphere(radius: 0.05))
        spere.geometry?.firstMaterial?.diffuse.contents = UIColor.blue
        spere.position = SCNVector3(0,0,0)
